...
# Getting data
Use the bundled synthetic reference from the importing data vignette. This
keeps the examples reproducible without downloading a genome. For a real
analysis, use a matching genome and annotation for your organism; see
`getGenomeAndAnnotation()` in the importing data vignette.

```{r eval = TRUE, echo = TRUE, message = FALSE}
library(ORFik)
reference_dir <- system.file("extdata/references/homo_sapiens", package = "ORFik")
output_dir <- tempfile("orfik-transcripts-")
...
indexFa(genome)
txdb <- makeTxdbFromGenome(gtf, genome, "Homo sapiens", return = TRUE)
```
