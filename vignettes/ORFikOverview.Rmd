...
Here we will use CageSeq data to set new Transcription Start Sites (TSS) and re-annotate 5' UTRs. This is useful to improve tissue specific transcripts. Since most eucaryotes usually have variance in TSS definitions. 
...
Note in ORFik you can load all transcript annotation in one line:
