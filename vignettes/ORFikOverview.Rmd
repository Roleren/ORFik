...
10. Automatic download of genome annotation from any species.
11. Automatic download and renaming of files from SRA, ERA and DRA. 
12. Simplifying working with massive amounts of datasets using the ORFik experiment class. 

The first 9 points on this list is described here, for more advanced use (point 10-12) check out the other vignettes. 
...
```{r eval = FALSE, echo = TRUE, message = FALSE}
writeXStringSet(orf_aa_seq, filepath = "uorfs.fasta")
```
