...
Welcome to the `ORFik` package. This vignette will walk you through our detailed 
package usage with examples, to just see how to get a ORFik report, see the other vignette.
...
```
You can see orf 1 named (uc010ogz.1_1) has a CTG start codon, a TAG stop codon and 159/3 = 53 bases. We will now look on ORFik functions to get startcodons and stopcodon etc.
...
Use findORFsFasta(is.circular = T).
