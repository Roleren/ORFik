...
If input is only .fasta file (), use , it will treat it as prokaryotic genome and find ORFs on the chromosomes assuming no splicing. If .gtf file is also supplied, sequences of transcripts from .gtf file will be extracted, using findMapORFs will search and also map to genome. 
