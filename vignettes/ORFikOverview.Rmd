...
`ORFik` is an R package containing various functions for analysis of RiboSeq, RNASeq, TCPseq and CageSeq data 
related to analysis of translation initation, focusing on 5' UTRs (leaders), it is generalized in the 
...
```
It will be a black box around the strongest nucleotide per position 
