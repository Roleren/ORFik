...
ORFik uses the fastp for trimming reads, this only works on linux. So for Mac users, do the trimming step first with your favorite trimmer if needed, then pass the trimmed files as input argument here. 
...
- steps: steps of depletion and alignment wanted:
		(a string: which steps to do? (default: "tr-ge", write "all" to get all: "tr-ph-rR-nc-tR-ge")
			 tr: trimming (only for Linux), ph: phix depletion, rR: rrna depletion,
