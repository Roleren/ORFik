...
ORFik comes with a SRA run downloader, just specificy the SRR numbers, or a SRA experiment information csv file containing a column called SRR. We will also only subset to download the 50000 first reads of the library. So you can replicate this faster.
