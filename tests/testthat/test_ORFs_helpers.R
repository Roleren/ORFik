...
test_that("pmapFromTranscriptsF works as intended", {
            ...
            TS = c(1,5,1000,1005,1008,2000,2003, 4000,5000, 7000, 85, 70,
                   101, 9)
            TE = c(3,9,1003,1006,1010,2001,2020, 4500,6000, 8000, 89, 82,
                   105, 9)
            ...
            expect_is(test_ranges, "GRangesList")
            expect_equal(start(unlistGrl(test_ranges)), c(1, 5, 1005, 1008,
                                                          2010, 5498, 7000, 85,
                                                          78, 78, 103, 9))
            expect_equal(end(unlistGrl(test_ranges)), c(3, 7, 1006, 1009,
                                                          2012, 6000, 7497, 85,
                                                          82, 82, 105, 9))
